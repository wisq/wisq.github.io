...
It took me trying a few different modpacks to settle on this one.  I quite like the visuals and the no-magic setting of Mount & Blade, and it seemed like most of the modpacks either wanted to introduce fantasy elements, and/or make everything look gritty and realistic.
...
Unless you're running a "twink" character like Thor, you may want to be decently versed in the base game before you try this modpack.  But if you're a Mount & Blade player (and you should be!) and you've seen it all and want to inject some more life into this wonderful game, give this pack a shot.
