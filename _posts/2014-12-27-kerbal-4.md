...
In this fourth and final KSP mod round-up, I'll be talking about mods that actually extend gameplay and let you do new things.  From Science to parachutes to colonisation to even building ships off-world, these mods can completely redefine your Kerbal experience.
...
This mod adds a ton of different ways to make things move.  Hinges, telescoping multi-segmented pistons, rotating sockets, gantry rails for full 3D movement movement … if you can imagine making it on a robot, chances are you can make it with Infernal Robotics.
